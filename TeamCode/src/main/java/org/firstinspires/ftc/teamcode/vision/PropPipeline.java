...
public class PropPipeline implements VisionProcessor {
    ...
    public static int blueLeftX = 1000;//(int) (240 / 1.5);
    public static int blueLeftY = 350;//(int) (525 / 1.5);
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        if (ALLIANCE == Location.RED && SIDE == Location.LOW || ALLIANCE == Location.BLUE && SIDE == Location.HIGH) {
